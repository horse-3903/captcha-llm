...
from sync_classes import CaptchaTester, GeminiCaptchaTester, OpenAICaptchaTester, OpenRouterCaptchaTester
from async_classes import AsyncCaptchaTester, GeminiAsyncCaptchaTester, OpenAIAsyncCaptchaTester, OpenRouterAsyncCaptchaTester

# gemini_model_lst = ["gemini-2.0-flash", "gemini-2.0-flash-lite", "gemini-1.5-flash", "gemini-1.5-flash-8b", "gemini-1.5-pro"]
...
if __name__ == "__main__":
    ...
    for i in range(3):
        prompt_id = i+1
        gemini_tester.set_result_path(f"./results/new/part-1/prompt-{prompt_id}/gemini/")
        gemini_tester.test_captcha(prompt_id=prompt_id, no_samples=500)